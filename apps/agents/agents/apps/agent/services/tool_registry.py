...
class ToolMeta:
    ...
    page_arg: str | None = None        # tool arg holding the target page id (page-binding gate)
    forbidden_when_page_bound: bool = False  # tool cannot be pinned to the bound page (e.g. creates pages)
...
DEFAULT_ENGINES_TOOLS: dict[str, ToolMeta] = {
    ...
    'getDatabaseSchema': ToolMeta('getDatabaseSchema', SCOPE_PAGES_READ, False,
                                  _summary_generic('getDatabaseSchema'), _preview_default,
                                  page_arg='pageId'),
    'queryDatabaseRecords': ToolMeta('queryDatabaseRecords', SCOPE_PAGES_READ, False,
                                     _summary_generic('queryDatabaseRecords'), _preview_default,
                                     page_arg='pageId'),
    ...
    'updatePage':        ToolMeta('updatePage', SCOPE_PAGES_WRITE, True,
                                   _summary_update_page, _preview_default, page_arg='pageId'),
    'movePage':          ToolMeta('movePage', SCOPE_PAGES_WRITE, True,
                                   _summary_move_page, _preview_default, page_arg='pageId'),
    'appendToPage':      ToolMeta('appendToPage', SCOPE_PAGES_WRITE, True,
                                   lambda a: f'Дописать в страницу {a.get("pageId")}', _preview_default,
                                   page_arg='pageId'),
    'renamePage':        ToolMeta('renamePage', SCOPE_PAGES_WRITE, True,
                                   lambda a: f'Переименовать страницу в «{a.get("title")}»', _preview_default,
                                   page_arg='pageId'),
    'replaceInPage':     ToolMeta('replaceInPage', SCOPE_PAGES_WRITE, True,
                                   lambda a: f'Заменить текст на странице {a.get("pageId")}', _preview_default,
                                   page_arg='pageId'),
    ...
    'uploadFileToPage':  ToolMeta('uploadFileToPage', SCOPE_FILES_WRITE, True,
                                   _summary_upload_file, _preview_default, page_arg='pageId'),
