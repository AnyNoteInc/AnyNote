...
export function HomeContact() {
  return (
    <Box component="section" id="contact" sx={{ bgcolor: 'background.paper', py: { xs: 7, md: 11 }, overflow: 'hidden' }}>
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', lg: '1fr 1.1fr' }, gap: { xs: 4, lg: 8 }, alignItems: 'center' }}>
          <Stack spacing={2}>
            ...
            <Box sx={{ position: 'relative', minHeight: 280, mt: 3, display: { xs: 'none', md: 'block' } }}>
              ...
              <Box sx={{ position: 'absolute', bottom: 18, right: 0, bgcolor: 'background.paper', border: '1px solid', borderColor: 'divider', borderRadius: 1.5, p: '14px 16px', boxShadow: '0 18px 40px rgba(0,0,0,0.08)', maxWidth: 240, zIndex: 2 }}>
          ...
          <Box sx={{ bgcolor: 'background.paper', border: '1px solid', borderColor: 'divider', borderRadius: 1.75, p: { xs: 3, md: 3.5 }, boxShadow: '0 24px 48px rgba(0,0,0,0.06)' }}>
            <ContactForm />
          </Box>
        </Box>
      </Container>
