...
export const landingPricingCards = [
  {
    title: "Free",
    price: "0",
    description: "Попробуйте — это бесплатно",
    items: ["До 3 пространств", "Редактор документов", "Общий доступ по ссылке"],
    cta: "Начать бесплатно",
  },
  {
    title: "Команда",
    price: "12",
    description: "Для команды, которая хочет навести порядок",
    items: [
      "Неограниченно пространств",
      "Поиск по смыслу документов",
      "Файлы, схемы, таблицы в одном месте",
    ],
    cta: "Попробовать",
  },
  {
    title: "Компания",
    price: "Custom",
    description: "Для компаний с требованиями к безопасности",
    items: [
