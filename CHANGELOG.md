...
* **database:** await file rollback and batch metadata ([0a86084](https://github.com/AnyNoteInc/AnyNote/commit/0a86084c6bd75b058a18727cc1831fa148f5b976))
* **database:** harden multi-file cell interactions ([0396375](https://github.com/AnyNoteInc/AnyNote/commit/0396375a4324bfd3f17ef03fa88a3b2234370fa9))
* **database:** normalize legacy files before computed cells ([5d83e6e](https://github.com/AnyNoteInc/AnyNote/commit/5d83e6efe241e2325bcd60784f437896c896ba4b))
* **database:** preserve archived view tombstones ([6937a74](https://github.com/AnyNoteInc/AnyNote/commit/6937a740094b85222ec00d3b5d54c97c76932c0d))
* **domain:** bound form grace version lookup ([57a58ad](https://github.com/AnyNoteInc/AnyNote/commit/57a58ad621628ba32e41c8a2224d30ccf30c1e80))
* **domain:** bound form parsing before validation ([77750be](https://github.com/AnyNoteInc/AnyNote/commit/77750be3bfa17c6acab540314ed1bf73f4e9ff17))
* **domain:** close database form lifecycle gaps ([a7589fc](https://github.com/AnyNoteInc/AnyNote/commit/a7589fc211f5d57be68cdd56bc544a4b9ae17a49))
* **domain:** enforce form size during sanitization ([0e59aa9](https://github.com/AnyNoteInc/AnyNote/commit/0e59aa9333d80a11bc2eb4dd4d55fbb80c6022b5))
* **domain:** enforce safe form answer boundaries ([88e41c5](https://github.com/AnyNoteInc/AnyNote/commit/88e41c5bb4024bcb1c14cc69a7c294cca43993c5))
* **domain:** guard form settings with snapshot CAS ([75344b8](https://github.com/AnyNoteInc/AnyNote/commit/75344b8e30d9df79f14866fd315186cdffed43aa))
* **domain:** harden database form lifecycle ([331499d](https://github.com/AnyNoteInc/AnyNote/commit/331499d8bb5b5afbe362b9021f1602cd0486667d))
* **domain:** harden form flow validation ([e555ee7](https://github.com/AnyNoteInc/AnyNote/commit/e555ee7ff8f4cc9c6263594e549321431b1ceea8))
* **domain:** reject malformed form redirects ([6a4ba68](https://github.com/AnyNoteInc/AnyNote/commit/6a4ba68f9ef516e9f69d6ff3ee8c0d35a71cc6b7))
* **domain:** reserve unsafe form question ids ([4e14200](https://github.com/AnyNoteInc/AnyNote/commit/4e142007e80dcd19b8d946c1b91b527b97d1b93f))
* **domain:** scale numeric step tolerance ([411b983](https://github.com/AnyNoteInc/AnyNote/commit/411b983b7533bac3ac03f3252fbedee112395dfd))
* **domain:** scope form dependencies and uow tests ([7750f53](https://github.com/AnyNoteInc/AnyNote/commit/7750f536c903c990962644e45f40043f57787782))
* **domain:** serialize form publication and bound lookups ([9236ce2](https://github.com/AnyNoteInc/AnyNote/commit/9236ce2f1d721e2ebd41e98ae23c301bfdec529b))
* **domain:** validate every active form version ([e6b6354](https://github.com/AnyNoteInc/AnyNote/commit/e6b6354019514cb4ef74e77bfef34256eb296125))
* **domain:** validate form grace audience ([ea6f204](https://github.com/AnyNoteInc/AnyNote/commit/ea6f204ef79c183ba870af23c3c20c77521645b4))
* **forms:** align row mutation lock order ([50f7e0a](https://github.com/AnyNoteInc/AnyNote/commit/50f7e0a1a7ea9376ee79ae6618998a66cf7d2484))
* **forms:** bound replay probes ([f861d60](https://github.com/AnyNoteInc/AnyNote/commit/f861d60bb4cf17fa9e12c2fc663108edca31d7dd))
* **forms:** close remaining upload quota races ([5acd1e7](https://github.com/AnyNoteInc/AnyNote/commit/5acd1e7663ce2e89046c2d4ae4dd99159919f31f))
* **forms:** extend import cleanup transaction budget ([4836078](https://github.com/AnyNoteInc/AnyNote/commit/4836078959dba412303f85ece400e7c0e28fad28))
* **forms:** fail fast on authority lock contention ([2da8199](https://github.com/AnyNoteInc/AnyNote/commit/2da81994791a9bd542e2b6f7ccb508eacb3383c2))
* **forms:** finish builder quality hardening ([e1bb422](https://github.com/AnyNoteInc/AnyNote/commit/e1bb42290923036fe62b03fa9213ef8572518420))
* **forms:** harden atomic form submission ([4fe9b70](https://github.com/AnyNoteInc/AnyNote/commit/4fe9b70226338fa39ac241cf724efc4075961964))
* **forms:** harden builder permissions and draft updates ([21a6bbb](https://github.com/AnyNoteInc/AnyNote/commit/21a6bbbf5ff593b1089aff450552f6921d01761b))
* **forms:** harden public form access ([a4861ee](https://github.com/AnyNoteInc/AnyNote/commit/a4861ee0617ca03cbd638f1fdb046947a090b342))
* **forms:** harden public submission contract ([afa2439](https://github.com/AnyNoteInc/AnyNote/commit/afa24393ca5a2469bb58774777e4bd0bd9102a79))
* **forms:** harden public submission protections ([4ed57e7](https://github.com/AnyNoteInc/AnyNote/commit/4ed57e7189c031fa690b9bd46c4678fa562f1854))
* **forms:** harden response access and embedded views ([5fcb8e0](https://github.com/AnyNoteInc/AnyNote/commit/5fcb8e0784a11c26263ba6a660d7d7997214884b))
* **forms:** harden upload quota and cleanup ([4a21404](https://github.com/AnyNoteInc/AnyNote/commit/4a2140491c07eca27571970825913e72acbcfd06))
* **forms:** isolate upload objects by workspace ([6bdb2d9](https://github.com/AnyNoteInc/AnyNote/commit/6bdb2d9a3aeffe5ec1ad476e16d0ec21a532aba2))
* **forms:** lock and batch submission authorities ([8171da4](https://github.com/AnyNoteInc/AnyNote/commit/8171da4a344db9ab9ae22e123e37a61daf7a1303))
* **forms:** narrow contention hardening ([2300931](https://github.com/AnyNoteInc/AnyNote/commit/2300931bfbc2f4f5d2a2306fa999c29a8639ddcf))
* **forms:** order submission authority locks ([c576f9f](https://github.com/AnyNoteInc/AnyNote/commit/c576f9feca68d5feb28a42531016609989b79371))
* **forms:** sanitize submission failures ([a6cfff3](https://github.com/AnyNoteInc/AnyNote/commit/a6cfff3349bf695fba3c1e2210239bf626520199))
* **forms:** stabilize autosave and complete release coverage ([cea20b5](https://github.com/AnyNoteInc/AnyNote/commit/cea20b5a5a85032f38f6d9b2e55435111df6511f))
* **web:** align form builder option dependencies ([4824d03](https://github.com/AnyNoteInc/AnyNote/commit/4824d034a22d11ff117e86a78ae10d787965e1f3))


### Features

* **database:** add form plan flags and multi-file cells ([8ec6718](https://github.com/AnyNoteInc/AnyNote/commit/8ec671833450a02e5ae4e6b298202c0a9d275f27))
* **db:** add database form persistence ([2eddc37](https://github.com/AnyNoteInc/AnyNote/commit/2eddc37d96a76c09388293ce5e106e3b8f7ad424))
* **domain:** add database form repository ([555f72f](https://github.com/AnyNoteInc/AnyNote/commit/555f72f046c1877fa35b5a8eabdfea35054d3699))
* **domain:** compile database form flows ([ad68736](https://github.com/AnyNoteInc/AnyNote/commit/ad687366da3761f18d8735c0e6edfb18d1c036eb))
* **domain:** define database form documents ([343efea](https://github.com/AnyNoteInc/AnyNote/commit/343efea51d44b36b98e97dae716f4ef2c07d0915))
* **domain:** implement database form lifecycle ([78b981a](https://github.com/AnyNoteInc/AnyNote/commit/78b981a25be322e16a171a65121eee95c3b1d2e0))
* **forms:** add atomic submission transaction core ([0de3a4d](https://github.com/AnyNoteInc/AnyNote/commit/0de3a4d87a03edac6baef8d6abc524f9d645ac58))
* **forms:** add leased public file uploads ([6e53d33](https://github.com/AnyNoteInc/AnyNote/commit/6e53d3301f70f7f07b9160ab8557b25c40224cee))
* **forms:** add public submission protections ([9867137](https://github.com/AnyNoteInc/AnyNote/commit/9867137de9f9769f3abb801eeb6fc01fccce9efe))
* **forms:** add respondent response access ([a92661c](https://github.com/AnyNoteInc/AnyNote/commit/a92661cced6e1d0c729550a5edea15c69a5287d6))
* **forms:** expose public form submission ([d4f973a](https://github.com/AnyNoteInc/AnyNote/commit/d4f973a5def417331eab71297d698634357916d8))
* **forms:** expose sanitized published forms ([549b54e](https://github.com/AnyNoteInc/AnyNote/commit/549b54e60f3b2827ee1abae44dd9874994ed7085))
* **forms:** notify on database form submission ([79decf6](https://github.com/AnyNoteInc/AnyNote/commit/79decf6dbff44ea4d82845f9340234d8b63fb5dc))
* **forms:** validate form targets and file leases ([3636afd](https://github.com/AnyNoteInc/AnyNote/commit/3636afdfd94d486c5c087ae1c72697b39106ef03))
* **forms:** validate scalar form responses server-side ([e33777c](https://github.com/AnyNoteInc/AnyNote/commit/e33777cdcec30194310953fc27a998370a292f80))
* **trpc:** expose database form management ([a3296fb](https://github.com/AnyNoteInc/AnyNote/commit/a3296fb65ba1ffbb2c23d4bb2e2e1b2519649ab3))
* **web:** add database form builder ([0190d28](https://github.com/AnyNoteInc/AnyNote/commit/0190d28d5e9942250439f737e37ae4b382969a48))
* **web:** add public database form renderer ([808ca23](https://github.com/AnyNoteInc/AnyNote/commit/808ca23350f6025041c2b0f9d130d92afb0912ee))
* **web:** complete database form builder controls ([592739a](https://github.com/AnyNoteInc/AnyNote/commit/592739a77eccc61f5a6e2f376dbf74eece4727bd))
