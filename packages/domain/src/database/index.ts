...
export { assertCanEditDatabaseStructure } from './services/database-structure-access.ts'
export type { DatabaseStructureSource } from './services/database-structure-access.ts'
