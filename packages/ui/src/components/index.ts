...
// MUI 9 removed the legacy *Outline icon exports (duplicates of *Outlined). We
// keep the historical `*OutlineIcon` export names — importers and the persisted
// TemplateTag.icon string 'WorkOutlineIcon' depend on them — but source them
// from the surviving *Outlined components.
export { default as ChatBubbleOutlineIcon } from '@mui/icons-material/ChatBubbleOutlined'
...
export { default as WorkOutlineIcon } from '@mui/icons-material/WorkOutlined'
...
export { default as DeleteOutlineIcon } from '@mui/icons-material/DeleteOutlined'
export { default as SyncIcon } from '@mui/icons-material/Sync'
export { default as ErrorOutlineIcon } from '@mui/icons-material/ErrorOutlined'
...
// Page-chat panel display modes (docked sidebar / floating window)
