...
const SHARE_ID = '44444444-4444-4444-9444-444444444444'
...
describe('page.share mutations', () => {
  ...
  it('addUser rejects an existing workspace member', async () => {
    ...
    await expect(
      caller(ctx(prisma)).addUser({ pageId: PAGE_ID, userId: '55555555-5555-4555-9555-555555555555', role: 'READER' }),
  ...
  it('removeUser deletes the grant', async () => {
    ...
    await caller(ctx(prisma)).removeUser({ pageId: PAGE_ID, userId: '55555555-5555-4555-9555-555555555555' })
    expect(prisma.pageShareUser.deleteMany).toHaveBeenCalledWith({
      where: { pageShareId: SHARE_ID, userId: '55555555-5555-4555-9555-555555555555' },
    })
  })
})
