...
export function renderAccountDeletionRequested(
  ...
  return {
    subject: 'Подтверждение удаления учётной записи «Любых заметок»',
    text:
      `Здравствуйте, ${p.firstName}.\n\n` +
      `Получен запрос на удаление вашей учётной записи «Любых заметок».\n` +
    ...
    html:
      ...
      `<p>Получен запрос на удаление вашей учётной записи «Любых заметок».</p>` +
